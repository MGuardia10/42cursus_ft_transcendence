...
const PADDLE_WIDTH_RATIO = 0.02; // 2.5% del ancho del campo
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: `${
              ((BALL_SIZE_RATIO * gameState.gameWidth) / gameState.gameHeight) *
              100
            }%`,
        ...
        {!gameState.gamePaused && (
          <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center">
            <div className="mb-2 text-xl font-bold text-text-tertiary drop-shadow">
              {t("firstToScore").replace(
                "{score}",
                finalPointsToWin.toString()
              )}
            </div>
