...
const Home: React.FC = () => {
	return (
		<div className="grid grid-col-1 grid-row-4 xl:grid-cols-[1fr_1fr_450px] xl:grid-rows-[300px_1fr] gap-4 w-full xl:h-screen p-6 md:p-10 bg-background-secondary rounded-md">
